...
usage() {
  cat <<'EOF'
Usage:
  ./scripts/demo-management.sh --profile shared-demo-production
  ./scripts/demo-management.sh --profile shared-demo-dev
...
exec "$ROOT_DIR/scripts/demo-line.sh" --profile "$2"
