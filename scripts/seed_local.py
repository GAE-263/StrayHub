...
CATEGORY_NAMES = {
    ...
    "gait": "走路姿勢",
    "defecation": "大便",
    "animal_interaction": "對其他狗",
    "appearance_special_status": "身體外觀",
}

OPTION_NAMES = {
    "completed": "有走完",
    "partially_completed": "走一半",
    "not_done": "沒走成(懶散不走)",
    "higher": "比平常好",
    "usual": "跟平常一樣",
    "lower": "比平常差",
    ...
    "no_encounter": "路上沒遇到",
    "none_found": "沒發現異狀",
    "skin_or_coat": "皮膚或毛髮異常",
    "wound": "傷口或紅腫",
    "other": "其他",
}

# "abnormal" 這個後綴在走路姿勢與大便兩個類別意思差很多（明顯不對 vs 有異狀），
# 共用後綴表達不出差異，所以用完整 Code 覆寫，不放進上面的通用表。
