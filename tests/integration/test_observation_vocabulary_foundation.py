...
def test_platform_seed_is_exact_frozen_walk_vocabulary() -> None:
    ...
    assert PLATFORM_OPTIONS == {
        "walk_completion": (
            "walk_completion.completed", "walk_completion.partially_completed",
            "walk_completion.not_done",
        ),
        "activity": ("activity.higher", "activity.usual", "activity.lower"),
        "gait": ("gait.normal", "gait.off", "gait.abnormal"),
        "defecation": (
            "defecation.normal", "defecation.soft", "defecation.none", "defecation.abnormal",
        ),
        "animal_interaction": (
            "animal_interaction.friendly", "animal_interaction.no_reaction",
            "animal_interaction.wary", "animal_interaction.no_encounter",
        ),
        "appearance_special_status": (
            "appearance.none_found", "appearance.skin_or_coat",
            "appearance.wound", "appearance.other",
        ),
    }
