...
_NEXT_STATES: dict[tuple[AdoptionDraftState, AdoptionPath | None], AdoptionDraftState] = {
    ...
    # AI 是 optional enhancement；沒有 AI 時必須直接進入聯絡資料流程。
    (_S.CONFIRMING_ANSWERS, _P.SPECIFIC_ANIMAL): _S.AWAITING_ADOPTER_NAME,
    ...
    # Deterministic matching 是必要基線；AI 未啟用時直接呈現規則式候選。
...
_PREVIOUS_STATE: dict[tuple[AdoptionDraftState, AdoptionPath | None], AdoptionDraftState] = {
    ...
    (_S.AWAITING_ADOPTER_NAME, _P.SPECIFIC_ANIMAL): _S.CONFIRMING_ANSWERS,
