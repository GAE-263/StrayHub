...
ALL_ANSWER_KEYS = MATCH_PREFERENCE_KEYS + ("phone_number",)

REQUIRED_KEYS_BY_PATH: dict[AdoptionPath, tuple[str, ...]] = {
    _P.SPECIFIC_ANIMAL: BASE_PREFERENCE_KEYS + ("phone_number",),
    _P.RECOMMEND_ME: MATCH_PREFERENCE_KEYS + ("phone_number",),
}
...
_NEXT_STATES: dict[tuple[AdoptionDraftState, AdoptionPath | None], AdoptionDraftState] = {
    ...
    (_S.CONFIRMING_TARGET_ANIMAL, _P.RECOMMEND_ME): _S.AWAITING_PHONE_NUMBER,
    ...
    (_S.ANSWERING_SCHEDULE, _P.SPECIFIC_ANIMAL): _S.AWAITING_PHONE_NUMBER,
    ...
    (_S.ANSWERING_PREFERENCE_SCHEDULE, _P.RECOMMEND_ME): _S.ANSWERING_PREFERENCE_SIZE,
    ...
    (_S.PRESENTING_MATCHES, _P.RECOMMEND_ME): _S.SELECTING_MATCHED_ANIMAL,
...
_PREVIOUS_STATE: dict[tuple[AdoptionDraftState, AdoptionPath | None], AdoptionDraftState] = {
    ...
    (_S.AWAITING_PHONE_NUMBER, _P.SPECIFIC_ANIMAL): _S.ANSWERING_SCHEDULE,
    ...
    (_S.ANSWERING_PREFERENCE_SIZE, _P.RECOMMEND_ME): _S.ANSWERING_PREFERENCE_SCHEDULE,
    ...
    (_S.SELECTING_MATCHED_ANIMAL, _P.RECOMMEND_ME): _S.PRESENTING_MATCHES,
    (_S.CONFIRMING_TARGET_ANIMAL, _P.RECOMMEND_ME): _S.SELECTING_MATCHED_ANIMAL,
    (_S.AWAITING_PHONE_NUMBER, _P.RECOMMEND_ME): _S.CONFIRMING_TARGET_ANIMAL,
...
def _validate_phone_number(value: Any) -> None:
    if not isinstance(value, str) or not _PHONE_PATTERN.match(value):
