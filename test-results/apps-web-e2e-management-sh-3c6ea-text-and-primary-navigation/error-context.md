...
- Name: apps/web/e2e/management-shell.spec.ts >> 管理工作台 Shell >> desktop can identify context and primary navigation
- Location: apps/web/e2e/management-shell.spec.ts:12:7
